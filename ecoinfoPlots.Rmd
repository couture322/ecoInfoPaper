...
statGrey=c('Unrecoverable'='gray87',
             'Emailed'='gray67',
             'Replied'='gray47',
             'SentData'='gray27',
             'Revised'='grey7',
...
broadPerc=ggplot(broadDf[broadDf$succ==0,],aes(x=category,y=(prop*100)))+
  ...
  annotate("text", x = 3, y=broadDf$prop[[4]]*100+2, label = as.character(broadDf[broadDf$category=="social" & broadDf$succ==0,"grpTots"]))+
...
bioPerc=ggplot(bioYN[bioYN$succ==0,],aes(x=subCat,y=(prop*100)))+
  ...
  annotate("text", x = 4, y=bioYN$prop[[3]]*100+3, label = as.character(bioYN[bioYN$category=="biological-fish" & bioYN$succ==0,"grpTots"]))+
