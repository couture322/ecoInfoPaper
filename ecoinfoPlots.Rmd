...
``` {r broad - bubble plot,echo=F}
ggplot(broadDf[broadDf$succ==0,], aes(x=factor(broad,levels=c('physical',"biological",'social',"oil",'modeling')), y=prop*100, size=grpTots, label=grpTots),guide=FALSE)+
  ...
  scale_y_continuous(name="% successful", limits=c(0,100))+
  theme(axis.line=element_line('black'),
        panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.border = element_blank(),
