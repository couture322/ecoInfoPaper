...
Chi-squared test for equal proportions between research fields - bio broken out
...
I use the "party" package in R to create a decision tree using the same model as the glm. 
